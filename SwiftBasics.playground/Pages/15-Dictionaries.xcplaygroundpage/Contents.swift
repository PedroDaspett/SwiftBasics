...
let myFruit = finalFruits[1] // if the index doesn't exist the app will crash, so this element is a String
...
let item = myFirstDictionary["Banana"] // if the key doesn't exist the value will be nil, so this element is a Bool?
