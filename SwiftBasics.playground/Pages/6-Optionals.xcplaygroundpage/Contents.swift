...
@MainActor // colocado para silenciar erro
...
// Below there is shown the same case but using both IF-LET and GUARD STATEMENT
...
// layered guard without comments
@MainActor
...
// explicitly unwrap optional - "The unsafe way"
// !
